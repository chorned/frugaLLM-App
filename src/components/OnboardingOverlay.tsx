      ...
      {targetRect && (
        ...
        >
          ...
          <div className="flex justify-end">
            <button
              onClick={onComplete}
              className="btn-cta px-6 py-2.5 bg-zen-text text-white hover:bg-neutral-800 text-sm font-medium rounded-full transition-all hover:shadow-sm active:scale-[0.98]"
            >
