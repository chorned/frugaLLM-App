  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/10 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-zen-surface border border-zen-border rounded-2xl p-8 max-w-lg w-full shadow-2xl shadow-glass transform transition-all">
        <h2 className="text-3xl font-bold text-zen-text mb-4 tracking-tight">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div className="flex flex-col text-left">
              <span className="text-lg font-semibold text-zen-text group-hover:text-zen-accent transition-colors">
            ...
            <span className="text-2xl opacity-0 group-hover:opacity-100 transform translate-x-[-10px] group-hover:translate-x-0 transition-all duration-300 text-zen-accent">
              →
            </span>
          </button>
